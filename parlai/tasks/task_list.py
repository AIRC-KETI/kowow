...
task_list = [
    ...
    {
        "id": "Wizard_of_Wikipedia_Ko",
        "display_name": "Wizard_of_Wikipedia_Ko",
        "task": "wizard_of_wikipedia_ko",
        "tags": ["ChitChat"],
        "description": (
            "A dataset with conversations directly grounded with knowledge "
            "retrieved from Wikipedia. Contains 201k utterances from 22k "
    ...
    {
        "id": "Wizard_of_Wikipedia_Ko_Generator",
        "display_name": "Wizard_of_Wikipedia_Ko_Generator",
        "task": "wizard_of_wikipedia_ko:Generator",
        "tags": ["ChitChat", "Dodeca"],
        "description": ("Wizard of Wikipedia task to train generative models"),
    },
    {
